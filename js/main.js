...
BRUSHED.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											...
											{image : 'img/slider-images/image04v5.jpg', title : '<div class="slide-content" ><br/><br/><br/> <div style="color:#333333"><br/></div>', thumb : '', url : ''}
									],
...
BRUSHED.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		url: "http://www.technicaleader.com/mail.aspx",
			...
			,error:function(){
					$('#response').empty().html("Sorry, an  error has occured. Please retry later.");
			}
